...
export default function Example() {
  ...
  const [items, setItems] = React.useState([
    { header: true, serie: "", nameHome: "", backgroundColorHome: "#008000", textColorHome: "#008000", pointsColorHome: "#008000", idHome: 0, ptsHome: 10001, nameAway: "", backgroundColorAway: "#008000", textColorAway: "#008000", pointsColorAway: "#008000", idAway: 0, ptsAway: 10001 },
    // { name: header, backgroundColor: "#008000", textColor: "#fff", pointsColor: "#008000", id: 0, pts: 10000 },

    { header: true , serie: "Série A"},
              ...
              // index % 3 == 1 && index > 2 ? { marginBottom: Dimensions.get('window').width * 0.04 } : {},
                  styles.itemContainer,
                  {
                    ...
                    width: Dimensions.get('window').width
                     ...
                     <Text adjustsFontSizeToFit={true} style={[styles.itemName, { color: "#fff" }]}>{item.serie}</Text>
              </View>
...
{/* Time Home */}
              ...
              styles.itemContainer,
              {
                ...
                <Text adjustsFontSizeToFit={true} style={[styles.itemName, { color: item.textColorHome }]}>{item.nameHome}</Text>
              </View>
...
{/*   X   */}
              <View style={[item.distrital || item.header ? { display: 'none', width: Dimensions.get('window').width * 0 } : { width: Dimensions.get('window').width * 0.054 },
              styles.itemContainer, {
                marginHorizontal: Dimensions.get('window').width * 0.003,
                // backgroundColor: item.backgroundColorAway
              }]}>

                <Text style={[styles.itemName, { color: "#fff" }]}>X</Text>
              </View>
